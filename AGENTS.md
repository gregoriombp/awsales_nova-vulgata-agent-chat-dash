...
Each lives in `.claude/skills/<name>/SKILL.md` (except `bombardier-generate.md`, which is flat). Invoke via `/<name>`; some trigger by context. All are **gitignored — local only, never shared**.
