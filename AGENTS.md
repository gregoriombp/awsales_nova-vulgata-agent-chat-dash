...
| Skill | When to use |
|---|---|
| `bombardier-generate` | Visual Page Builder system prompt (canvas); emits `BuilderNode[]` JSON into `components/playground/` (quarantine, no `Aw` prefix until promoted). |
