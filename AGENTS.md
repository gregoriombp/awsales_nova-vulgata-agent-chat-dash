...
- **TypeScript check**: `npm run typecheck` (there are 2 pre-existing TS errors in `app/bombardier/styleguide/components/integration-card/page.tsx` — known debt, not blocking).
