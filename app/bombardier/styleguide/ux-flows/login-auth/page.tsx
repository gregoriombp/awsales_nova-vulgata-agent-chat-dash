    ...
    <>
      ...
      <div className="max-w-[1400px] mx-auto px-10 pb-14 flex flex-col gap-16">
        ...
        <Section
          id="flow"
          title="Fluxograma"
          lead="Passe o mouse em qualquer tela e clique no olho pra abrir o protótipo num painel lateral. Caixas tracejadas em âmbar são decisões. Setas âmbar indicam bifurcações. OAuth Google e Microsoft seguem pelos corredores laterais sem cruzar o fluxo central."
        >
