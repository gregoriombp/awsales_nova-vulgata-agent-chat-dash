      ...
      <div className="-m-8">
        <div className="bg-white border-b border-[#f2f2f2]">
          <div className="mx-auto max-w-[1544px] px-12 py-8">
            <h3 className="text-[#1a1a1a]">Busca semântica</h3>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-[1544px] px-12 pt-8 pb-14 space-y-6">
            ...
            <div>
              <input
                ...
                className="w-full max-w-2xl h-11 px-4 rounded-lg border border-[#e5e5e5] bg-[#f9f9f9] body-sm text-[#1a1a1a] placeholder:text-[#737373] focus:outline-none focus:ring-2 focus:ring-[#0d0d0d] focus:border-transparent"
              />
            </div>
            ...
            <div>
              <button
                type="button"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-[#e5e5e5] bg-white body-sm font-medium text-[#2f2f2f] hover:bg-[#f9f9f9] transition-colors"
              >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <h6 className="text-[#1a1a1a]">Todos os trechos</h6>
                <span className="inline-flex items-center justify-center min-w-[28px] h-6 px-2 rounded-md bg-[#f2f2f2] body-xs font-medium text-[#525252]">
                ...
                {filteredChunks.map((chunk) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="body-sm font-medium text-[#1a1a1a]">{chunk.label}</span>
                      <span className="body-xs text-[#737373]">
                        {chunk.characterCount.toLocaleString("pt-BR")} caractere{chunk.characterCount !== 1 ? "s" : ""}
                      </span>
                    </div>
                    <p className="body-xs text-[#2f2f2f] leading-relaxed pl-6">{chunk.snippet}</p>
                    <div className="pl-6 flex items-center gap-2 body-xs text-[#5e5e5e]">
