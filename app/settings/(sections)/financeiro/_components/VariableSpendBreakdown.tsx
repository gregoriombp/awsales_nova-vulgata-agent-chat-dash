...
import { LimitEventMarkers } from "./LimitEventMarkers";
  ...
  return (
    <div className="rounded-xl border border-(--border-subtle) px-5 pb-4 pt-6">
      ...
      >
        ...
        {/* marcadores de evento: limite atingido → cobrança → restaurado —
            componente compartilhado com o explorador de custos (LimitEventMarkers). */}
        <LimitEventMarkers events={events} />
