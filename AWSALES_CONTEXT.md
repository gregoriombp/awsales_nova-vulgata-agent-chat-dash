...
> Para o toolkit visual atual: [BOMBARDIER.md](./BOMBARDIER.md). Para o método: [README.md](./README.md). (Histórico de decisões: `git log` — não há CHANGELOG.md neste repo.)
...
3. **Sobre o método Bombardier (design-as-product)**: use [BOMBARDIER.md](./BOMBARDIER.md) como mapa operacional deste repo.
