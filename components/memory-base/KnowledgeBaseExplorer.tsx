          ...
          options.map((opt) => {
            ...
            return (
              <button
                ...
                className="flex w-full items-center justify-between gap-2 rounded-md px-2.5 py-2 text-left text-sm text-(--fg-primary) transition-colors hover:bg-(--bg-hover)"
              >
...
export function KnowledgeBaseExplorer({ bases }: { bases: KnowledgeBase[] }) {
  ...
  return (
    <div className="mt-8 flex flex-col gap-6">
      ...
      {/* Resultado */}
      {filtered.length === 0 ? (
        <div className="rounded-xl border border-dashed border-(--border-subtle) py-16 text-center text-sm text-(--fg-tertiary)">
