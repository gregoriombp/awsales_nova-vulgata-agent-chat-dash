      ...
      >
        ...
        <SwitchPrimitive.Root
          ...
          className={cn(
            ...
            "focus-visible:ring-1 focus-visible:ring-[var(--ring-focus)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-canvas)]"
          )}
          style={{
            width: TRACK_WIDTH,
            height: TRACK_HEIGHT,
        ...
        >
          <SwitchPrimitive.Thumb asChild>
            <motion.span
              className="absolute top-0 left-0 block rounded-full bg-bg-raised shadow-sm"
              initial={false}
              style={{ x: motionX }}
              animate={{
                y: thumbY,
        ...
        <span
          className={cn(
            ...
            checked ? "text-fg-primary" : "text-fg-muted"
          )}
        >
          {label}
        </span>
