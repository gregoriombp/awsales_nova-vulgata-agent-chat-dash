      ...
      <CheckboxGroupContext.Provider value={{ registerItem, activeIndex }}>
        ...
        >
          ...
          <AnimatePresence>
            {focusRect && (
              <motion.div
                className={`absolute ${shape.focusRing} pointer-events-none z-20 border border-[var(--ring-focus)]`}
                initial={false}
                animate={{
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={cn(
              "absolute inset-0 rounded-xs border-solid transition-all duration-80",
              checked
            ...
            {checked && (
              <CheckboxPrimitive.Indicator forceMount asChild>
                <motion.svg
                  ...
                  className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-brand"
                  initial={{ opacity: 1 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 1 }}
                >
