...
function ValueDisplay({
        ...
        <span className="inline-grid text-sm">
          ...
          <span className="col-start-1 row-start-1 flex items-center gap-1">
            ...
            <input
              ...
              className={cn(
                "w-[5ch] bg-transparent text-fg-primary outline-none border-b border-border text-center",
                shape.input
              )}
              style={{ fontVariationSettings: fontWeights.medium }}
            />
  ...
  return (
    <span
      className={cn(
        "inline-grid shrink-0 text-sm leading-none text-fg-muted transition-[font-variation-settings] duration-100",
        "tabular-nums"
      )}
      style={{
...
function TooltipValue({ value, formatValue, motionX }: TooltipValueProps) {
  ...
  return (
    ...
    >
      <span
        className={cn("text-xs text-fg-on-inverse tabular-nums whitespace-nowrap bg-bg-inverse px-2 py-1", shape.bg)}
        style={{ fontVariationSettings: fontWeights.medium }}
      >
        {formatValue(value)}
      </span>
      ...
      return (
        ...
        >
          <motion.span
            ...
            transition={springs.fast}
            style={{
              backgroundColor: thumbColor ?? "var(--bg-raised)",
          ...
          {/* Focus ring */}
          <motion.span
            className="absolute rounded-full border border-[var(--ring-focus)] pointer-events-none"
            initial={false}
            animate={{
              ...
              <motion.div
                ...
                style={{
                  ...
                  borderRadius: hoverPreview && hoverPreview.cursorX > hoverPreview.left
                    ? "0 9999px 9999px 0"
                    : "9999px 0 0 9999px",
                  backgroundColor: "color-mix(in srgb, var(--accent-brand) 25%, transparent)",
                }}
              />
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            width: hoverPreview ? hoverPreview.width : 0,
            backgroundColor: "color-mix(in srgb, var(--bg-selected) 40%, transparent)",
          }}
        />
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    initial={false}
                    animate={{
                      backgroundColor: isActivePip ? "var(--fg-primary)" : "var(--fg-muted)",
        ...
        {variant === "pips" && (
          <div className="absolute inset-0 flex items-center px-2 z-[2] pointer-events-none" aria-hidden>
            {label && (
              <span className="text-sm px-2 bg-bg-canvas text-transparent select-none">
                {label}
              </span>
            )}
            <span
              className="text-sm tabular-nums ml-auto px-2 bg-bg-canvas text-transparent select-none"
          ...
          <motion.div
            ...
            animate={{
              ...
              backgroundColor: isFocused
                ...
                : "color-mix(in srgb, var(--fg-primary) 25%, transparent)",
            }}
            transition={springs.fast}
            style={{
          ...
          <div className="absolute inset-0 flex items-center px-2 z-[4] pointer-events-none">
            {label && (
              <motion.span
                ...
                initial={false}
                animate={{ color: isActive ? "var(--fg-primary)" : "var(--fg-muted)" }}
                transition={springs.fast}
              >
                {label}
              </motion.span>
