...
function StepMarker({
  ...
  if (status === "current") {
    return (
      <span className="relative z-10 grid h-8 w-8 place-items-center rounded-full bg-aw-blue-600 text-aw-white shadow-[0_0_0_4px_var(--bg-raised)]">
      ...
      >
        ...
        {!isExpanded && (
          <Icon
            name="chevron_right"
            size={20}
            className="shrink-0 text-[var(--fg-tertiary)] transition-colors group-hover:text-[var(--fg-primary)]"
          />
        )}
      </button>
  ...
  return (
    <section className={cn("flex flex-col gap-6", className)}>
      ...
      <div className="flex items-center gap-3 text-[var(--fg-secondary)]">
        ...
        <span className="body-sm tabular-nums text-[var(--fg-secondary)]">
      ...
      >
        <div className="rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--bg-raised)] p-6 md:p-8">
        ...
        {preview && (
          <div className="hidden lg:flex lg:items-start lg:pl-6">
            <div className="w-full overflow-hidden rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--bg-surface)]">
              {preview}
            </div>
          </div>
        )}
