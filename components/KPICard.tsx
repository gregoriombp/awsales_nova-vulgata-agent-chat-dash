...
export default function KPICard({ value, label, change, changePositive = true }: KPICardProps) {
  return (
    <div className="bg-white rounded-xl border border-[#e5e5e5] p-6">
      <div className=" font-bold text-text-primary mb-1">{value}</div>
      <div className="body-sm text-text-secondary mb-3">{label}</div>
      <div className={`flex items-center gap-1 body-sm font-medium ${
