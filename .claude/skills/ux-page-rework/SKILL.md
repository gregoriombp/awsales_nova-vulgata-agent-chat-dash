---
name: ux-page-rework
description: Audita uma página de produto (e suas subpáginas) e entrega DUAS direções de melhoria diferentes — uma de refinamento (mantém estrutura, afina componentes e UX writing) e outra de reestruturação (reorganiza hierarquia de informação, propõe novos padrões) — cada uma na sua própria branch, sem merge. Use sempre que o usuário pedir "melhorar página", "rework página", "refinar página", "auditar UX desta tela", "criar 2 versões de melhoria", "redesign /<rota>", "propor melhorias pra essa página", ou colar uma URL/rota e pedir audit/melhoria UX. Também vale quando o usuário diz "compare com Mobbin/Dribbble/concorrente X" sobre uma página existente. Ideal pra repos de preview UI/UX (Next.js + design system) que precisam de duas direções implementáveis pra mesma tela.
---
